...
Stage 3-4 : ROS & HW     →  ROS 2 Middleware, Hardware Interface
Stage 5-6 : Intelligence →  Navigation, Localization, Perception, AI
Stage 7-8 : Embedded     →  Firmware, Real-Time, Jetson Integration
Stage 9   : Production   →  Fleet Management, Cloud, OTA
```
...
- [x] Git (branching, commit, merge, rebase)
...
- [ ] Nav2 (Behavior Tree, Planner, Controller)
...
- [ ] ROS 2 + Embedded Bridge (Micro-ROS)
